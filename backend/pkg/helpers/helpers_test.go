...
func TestGetConfig(t *testing.T) {
	...
	require.NoError(t, os.Setenv("SHORT_LINK_BASE", "http://localhost:15001/"))
	require.NoError(t, os.Setenv("ALLOW_CORS_FROM", "localhost:3000"))
	require.NoError(t, os.Setenv("POSTGRES_CONN_STRING", "postgres://user:password@localhost:5432/linkShortener"))
